...
/** True while a battle is open, i.e. while BattleOverlay owns the pass control. */
export function useInBattle(): boolean {
  return useStore((s) => s.gameState !== null && s.gameState.battle !== null);
}
