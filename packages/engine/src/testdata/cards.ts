...
function leader(cardId: string, name: string, color: string, life: number): CardDefinition {
  return { cardId, name, category: 'leader', color, cost: 0, power: 5000, counter: 0, life, keywords: [] };
}
...
function event(cardId: string, name: string, color: string, cost: number): CardDefinition {
  return { cardId, name, category: 'event', color, cost, power: 0, counter: 0, life: 0, keywords: [] };
}

function stage(cardId: string, name: string, color: string, cost: number): CardDefinition {
  return { cardId, name, category: 'stage', color, cost, power: 0, counter: 0, life: 0, keywords: [] };
}
...
export const TEST_CARDS: CardDefinition[] = [
  ...
  character('TEST-008', 'Red Enforcer', 'red', 6, 7000, 0),
  character('TEST-009', 'Red Titan', 'red', 8, 9000, 0),
  character('TEST-010', 'Red Colossus', 'red', 10, 12000, 0),
  ...
  character('TEST-108', 'Green Enforcer', 'green', 6, 7000, 0),
  character('TEST-109', 'Green Titan', 'green', 8, 9000, 0),
  character('TEST-110', 'Green Colossus', 'green', 10, 12000, 0),
